---
title: 'Role Paths'
shortTitle: 'Role Paths'
description: 'Your first 10 minutes, per seat, the on-ramp per role, ending at the demo manual section for your depth.'
eyebrow: 'Authoring · 14 of 17'
order: 14
---

The [demo manual](/docs/oiml-rec/13-running-the-demo) is the reference; this page
...
Depth: [demo manual §4](/docs/oiml-rec/13-running-the-demo).
...
never decorative. Depth: [demo manual §4 + §6½](/docs/oiml-rec/13-running-the-demo)
and [the operator guides §B](/docs/oiml-rec/15-operator-guides).
...
coverage, not by convention. Depth: [demo manual §4](/docs/oiml-rec/13-running-the-demo).
...
certificate machine alike. Depth: [demo manual §5–§7](/docs/oiml-rec/13-running-the-demo)
and [the operator guides §C](/docs/oiml-rec/15-operator-guides).
...
Depth: [demo manual §4–§7](/docs/oiml-rec/13-running-the-demo) and the architecture
...
3. Then read the three-layer story in the architecture site's
   ...
   (tier-1 hands-on, see the [demo manual §8](/docs/oiml-rec/13-running-the-demo)).
...
`tour` console command, and the [demo manual §8](/docs/oiml-rec/13-running-the-demo).
