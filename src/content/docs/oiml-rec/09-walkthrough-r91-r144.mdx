---
title: 'Walkthrough: R 91 and R 144'
shortTitle: 'Walkthrough: R 91 + R 144'
description: 'Traffic speed meters and gas analytical systems: the stress cases.'
eyebrow: 'Authoring · 09 of 17'
order: 9
---
...
**Answer.** Two seeded flows (one multi-component, one single-channel) run
