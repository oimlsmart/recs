---
title: 'Walkthrough: R 60'
shortTitle: 'Walkthrough: R 60'
description: 'The worked example, end to end.'
eyebrow: 'Authoring · 08 of 17'
order: 8
---
...
fifteen real certificate PDFs (the public OIML-CS register, issuer and
manufacturer names replaced by the fictional set): one manufacturer →
one family (`technology: digital`,
`humidity_symbol: CH`, `construction: strain-gauge`, parameters p_LC
0.7, t_min −10 °C, t_max +40 °C…) → groups by classification label
(`grp-acme-lc-d1` with `group_label: "D1"`, n_lc 6000, Y 20000,
...
[chapter 14](https://www.primmel.org/primmel-smart-docs/primmel/14-live-twins/) (Primmel SMART docs), §14.9 shows the same package
...
*Next: [Chapter 9, Walkthrough: R 91 and R 144](/docs/oiml-rec/09-walkthrough-r91-r144):
