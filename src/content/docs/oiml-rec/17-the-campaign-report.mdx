---
title: 'The Demonstration Campaign Report'
shortTitle: 'The Campaign Report'
description: 'The first demonstration campaign, executed 2026-08-01 against the OIML SMART SST.'
eyebrow: 'Authoring · 17 of 17'
order: 17
---
...
> [protocol](/docs/oiml-rec/16-real-instrument-campaign) step for step. Every number
...
- **Surveillance.** The monitor's schedule ran the quarter-accrual
  pattern (the live-twin e2e suite, `pilot`: 2,147 + 2,147 pass verdicts; drift flags, an
...
## 5. What the physical campaign still owes
...
The certification chain this demonstration's twins plug into now runs end to
end in the app: [the OIML-CS flow, executable](/docs/oiml-cs/08-the-flow-executable)
