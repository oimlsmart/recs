...
description: 'Anatomy; binding; OCL limits; applicability; verification methods; tables and profiles.'
eyebrow: 'Authoring · 03 of 17'
order: 3
---
...
*Next: [Chapter 4, Conformance Tests](/docs/oiml-rec/04-conformance-tests): the
