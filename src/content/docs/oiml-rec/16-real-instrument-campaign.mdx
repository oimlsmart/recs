---
title: 'The Real-Instrument Campaign'
shortTitle: 'The Campaign Protocol'
description: 'The real-instrument campaign protocol, execution-ready, waiting on a physical instrument with a Primmel SMART twin.'
eyebrow: 'Authoring · 16 of 17'
order: 16
---
...
against the simulated SMART twins. The real-instrument campaign proves the program
...
The campaign instrument must provide one of:
...
**Candidate profile (R 60, the reference campaign):** a digital load cell
...
the campaign targets a Modbus-RTU cell; a second transport is a new
config, never new code.

## 4. The evidence-review checklist (the human expert's pass)

The campaign's decision record is reviewed by a metrologist who did not
