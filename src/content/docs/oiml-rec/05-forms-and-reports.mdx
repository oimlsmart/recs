...
shortTitle: 'Forms and Reports'
description: 'Bind paths; measurement methods; pass/fail; the test-report skeleton; checklists; omissions.'
eyebrow: 'Authoring · 05 of 17'
order: 5
---
...
not required for it; a deliberately skipped in-scope form is an
omission (§5.8).
...
*Next: [Chapter 6, Evaluation](/docs/oiml-rec/06-evaluation): determinations,
