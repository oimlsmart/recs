---
title: 'Modelling Your Product'
shortTitle: 'Modelling Your Product'
description: 'The manufacturer’s product reference package (the ACME LC-500 worked example).'
eyebrow: 'Authoring · 12 of 17'
order: 12
---
...
> **ACME's LC-500** load cell mapped to R 60, consumed by a quarry's
> belt scale, both fictional, the simulator's demonstration scenario. The normative spec of the supply-chain model is
> Volume I, [chapter 15](https://www.primmel.org/primmel-smart-docs/primmel/15-model-supply-chain/) (Primmel SMART docs), this
...
validate section 1h) computes all of it on every build; the live
demonstration's steady state is the proof:
...
## 12.8 The live demonstration, end to end
...
From a clean checkout, the demonstration (the `pilot` suite):
...
[chapter 15](https://www.primmel.org/primmel-smart-docs/primmel/15-model-supply-chain/); the twin machinery
(mode 2) in [chapter 14](https://www.primmel.org/primmel-smart-docs/primmel/14-live-twins/), both on the Primmel SMART docs site.*
