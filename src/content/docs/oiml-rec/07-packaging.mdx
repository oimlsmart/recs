...
description: 'The package layout; uses composition; sample data; registration.'
eyebrow: 'Authoring · 07 of 17'
order: 7
---
...
15](https://www.primmel.org/primmel-smart-docs/primmel/15-model-supply-chain/), on the Primmel SMART docs site) adds a fourth, published by the
...
*Next: [Chapter 8, Walkthrough: OIML R 60](/docs/oiml-rec/08-walkthrough-r60):
