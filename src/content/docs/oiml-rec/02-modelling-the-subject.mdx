---
title: 'Modelling the Subject'
shortTitle: 'Modelling the Subject'
description: 'Subject types, variants, dimensions, attributes, capabilities, behaviors, conditions.'
eyebrow: 'Authoring · 02 of 17'
order: 2
---
...
14](https://www.primmel.org/primmel-smart-docs/primmel/14-live-twins/), on the Primmel SMART docs site) needs two more declarations, both
...
*Next: [Chapter 3, Requirements](/docs/oiml-rec/03-requirements): constraints bound
