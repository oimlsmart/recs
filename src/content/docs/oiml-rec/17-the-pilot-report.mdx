---
title: 'The Pilot Report'
shortTitle: 'The Pilot Report'
description: 'The first campaign, executed 2026-08-01 against the OIML SMART SST.'
...
> [protocol](/docs/oiml-rec/16-real-instrument-pilot) step for step. Every number
