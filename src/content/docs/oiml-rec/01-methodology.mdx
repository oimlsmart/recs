---
title: 'The Authoring Method'
shortTitle: 'The Authoring Method'
description: 'The end-to-end method in seven moves; the validation gates; the pitfalls catalog.'
eyebrow: 'Authoring · 01 of 17'
order: 1
---
...
*Next: [Chapter 2, Modelling the subject](/docs/oiml-rec/02-modelling-the-subject):
