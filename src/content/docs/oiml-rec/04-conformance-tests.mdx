...
shortTitle: 'Conformance Tests'
description: 'Variables and sources; steps; conditions; acceptance criteria; inheritance; instances; kinds and obligation.'
eyebrow: 'Authoring · 04 of 17'
order: 4
---
...
*Next: [Chapter 5, Forms and Reports](/docs/oiml-rec/05-forms-and-reports): the
