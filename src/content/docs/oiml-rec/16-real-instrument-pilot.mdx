---
title: 'The Real-Instrument Pilot'
shortTitle: 'The Pilot Protocol'
description: 'The pilot protocol, execution-ready, waiting on a physical instrument with a Primmel SMART twin.'
