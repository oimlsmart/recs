...
shortTitle: 'Operator Guides'
description: 'The twin flows, per role: twin-lab operator, lab tester, scheme operator, auditor.'
eyebrow: 'Authoring · 15 of 17'
order: 15
---
...
[the Platform volume](https://www.primmel.org/primmel-smart-docs/platform/) on the Primmel SMART docs site; these are the how-tos.
...
[the multi-standard projection chapter](https://www.primmel.org/primmel-smart-docs/platform/04-multi-standard-projection/) (Primmel SMART docs)
carries the doctrine.

---

*Next: [Running the demo](/docs/oiml-rec/13-running-the-demo) (the full manual)
or [Role paths](/docs/oiml-rec/14-role-paths) (your first hour per seat).*
