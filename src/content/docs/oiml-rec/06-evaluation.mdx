...
description: 'Determinations, verdicts, model evaluation, decision; the certificate template; approvals.'
eyebrow: 'Authoring · 06 of 17'
order: 6
---
...
*Next: [Chapter 7, Packaging](/docs/oiml-rec/07-packaging): the `data/<rec>/`
